...
Chương 16, 16, 17 phải viết với **sáu ô để trống** vì Kujiale không công bố. Sáu ô này khoá được trong **mười lăm phút mở app** — và ô I2 quyết định cả quy trình dựng clip của công ty.
...
| **I2** ⛔ | **Bấm vào `构图比` ở bước `基础设置` → chụp DANH SÁCH ĐẦY ĐỦ các tỉ lệ chọn được. CÓ 9:16 KHÔNG?** Đây là ô quan trọng nhất nhóm: có 9:16 gốc thì bỏ hẳn bước cắt dọc ở CapCut (C16 §16.4, C18) | |
| **I3** | Tìm chỗ nào ghi **FPS** xuất ra, hoặc mở nút `降低帧率`. Sách chỉ biết là "tồn tại một FPS mặc định", không biết bao nhiêu. Số này quyết định có phải ép fps khi ghép với clip quay điện thoại không (C18) | |
...
> 📌 **I2 làm trước, làm ngay.** Mười giây bấm chuột. Kết quả quyết định cả C16 §16.4 lẫn quy trình dựng ở C18 — và quyết định luôn việc mỗi clip có mất thêm một bước cắt dọc hay không.
