...
CHAPTERS = [
    ...
    ("15", "15-xuat-video-kujiale.md", "15", "Chương 15", "Xuất video từ Kujiale",
     "Làm được gì, mất bao nhiêu 额度, vướng ở đâu — và câu hỏi dọc 9:16 trả lời dứt điểm.", "#2470f2", "ch"),
    ("16", "16-duong-di-may-anh.md", "16", "Chương 16", "Đường đi máy ảnh",
     "Điểm mốc, tốc độ, góc nhìn — làm clip dạo quanh mượt và không gây chóng mặt.", "#2b64e8", "ch"),
    ("17", "17-hau-ky-clip-doc.md", "17", "Chương 17", "Hậu kỳ clip dọc",
     "Kéo render về phía cảnh quay thật, ghép b-roll không chỏi, xuất chuẩn TikTok–Facebook.", "#3959de", "ch"),
    ("18", "18-noi-dung-clip-ra-khach.md", "18", "Chương 18", "Nội dung clip ra khách",
     "Sáu dạng clip nhà ở, ba giây đầu cho hình dựng, và cái gì của Trung Quốc bê sang Việt Nam được.", "#484ed4", "ch"),
